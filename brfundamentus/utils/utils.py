...
def compute_greenblatt_rank(stocks):
    ...
    """
    ranks_dict = {stock.ticker: {"rank_ev_ebit": None,
                                 "rank_roic": None, "total_rank": None} for stock in stocks}

    stocks_with_positive_ev_ebit = [stock for stock in stocks
    ...
    stocks_with_greenblatt_rank = [
        stock for stock in stocks if ranks_dict[stock.ticker]['total_rank'] is not None]
